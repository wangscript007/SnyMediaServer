  ...
  namespace Http
  {
    ...
    namespace Response
    {
      ...
      namespace Header
      {
        ...
        DECLARE_STRING_CONSTANT(AccessControlAllowHeaders, Access-Control-Allow-Headers)
        DECLARE_STRING_CONSTANT(AccessControlAllowMethods, Access-Control-Allow-Methods)
        DECLARE_STRING_CONSTANT(AccessControlAllowCredentials, Access-Control-Allow-Credentials)
