  ...
  namespace Http
  {
    namespace Content
    {
      namespace Type
      {
        ...
        DECLARE_HTTP_CONTENT_TYPE(m3u8, application/x-mpegURL)
        DECLARE_HTTP_CONTENT_TYPE(ts, video/MP2T)
        DECLARE_HTTP_CONTENT_TYPE(css, text/css)
        DECLARE_HTTP_CONTENT_TYPE(js, application/javascript)
        DECLARE_HTTP_CONTENT_TYPE(woff, font/woff)
